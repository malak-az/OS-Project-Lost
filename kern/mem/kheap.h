...
struct pages_block_info
{
    ...
    int num_of_pages_occupied;
    bool notfree;

    LIST_ENTRY(pages_block_info) prev_next_info;
};

*/

LIST_HEAD(pages_block_info_List, pages_block_info);
struct pages_block_info_List block_list;
